package com.customer.account.demo.constant;
...
public class ApiHeaderConstants {
    ...
    public static final String SURESH_CHANNEL = "x-suresh-channel"; // Identifies type of customer channel.
